...
exports.resolveCarImages = resolveCarImages;
const imageManifest_1 = require("../data/imageManifest");
...
function resolveCarImages(carId) {
    const entry = imageManifest_1.IMAGE_MANIFEST[carId];
    if (!entry)
        return null;
    return {
